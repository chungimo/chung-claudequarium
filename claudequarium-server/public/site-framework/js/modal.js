  ...
  _create() {
    ...
    this.element.innerHTML = `
      <div class="sf-modal-header">
        ...
        ${this.closable ? '<button class="sf-modal-close" aria-label="Close">&times;</button>' : ''}
      </div>
      <div class="sf-modal-content">
        ${typeof this.content === 'string' ? this.content : ''}
      </div>
      ${this.footer !== null ? `<div class="sf-modal-footer">${this.footer}</div>` : ''}
    `;
...
export class ConfirmModal extends Modal {
  constructor(options = {}) {
    ...
    super({
      ...
      `,
      footer: `
        <button class="sf-btn sf-btn-${options.confirmStyle || 'primary'}" id="confirm-yes">
          ${options.confirmText || 'Confirm'}
        </button>
        <button class="sf-btn sf-btn-secondary" id="confirm-no">
